    ...
    return (
        <Container fluid className="background-image-confirm-assistance" >
            <div style={{paddingTop: "5%", paddingBottom: "5%"}}>
                ...
                <Row>
                    <Col><h3 className="wedding-font-xsm center-text lateral-padding blue-green">Si desean acompañarnos, agradecemos confirmar su asistencia antes del “27 de febrero”</h3></Col>
                </Row>
                <Row>
                ...
                <Row className="align-items-center justify-content-center text-center mx-auto">
                    <Col>
                    <a href="https://wa.me/+5067192110?text=Hola,%20confirmo%20mi%20asistencia%20a%20la%20boda%20de%20Alexis%20y%20Keilyn.%20Atentamente:%20Por%20favor%20escriba%20su%20nombre%20o%20Familia%20y%20los%20invitados%20a%20asistir:" target="_blank">
